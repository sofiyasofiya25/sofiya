no'''implement a class called bank account that represents a bank account the class should have private 
...
class bankaccount:
  ...
  def deposit (self, amount ):
    if amount > 0:
      ...
      #self.__account_balance=self.__account _balance+amount 
